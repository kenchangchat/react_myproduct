...
function ProductDetailPage() {
  ...
  const focusBarcode = window.location.pathname.split("/");
  ...
  const getDataProductDetail = () => {
    requestPOST(
      "/getDataProduct",
      { product_id: focusBarcode.at(-1) },
      function (response) {
        if (response.success) {
        ...
        // console.log(data);
          ...
          setDataImage("");
          if (data.product_img) {
            var path = "/image/product/" + data.product_img;
            setDataImage(path);
          }
        }else{
          Swal.fire({
              title: "ERROR!",
              html: "เกิดข้อผิดพลาดในการดึงข้อมูล",
              icon: 'error',
  ...
  const onSubmit = (e) => {
    ...
    console.log("params: ", params);
      requestPOST_PRODUCT("/updateDataProduct", params, function (response) {
        ...
        if (response.success == true) {
          ...
          Swal.fire({
            ...
            window.location.replace("/product/"+dataInput.id);
          });
        } else {
          setLoading(false);
          Swal.fire({
                    ...
                    {dataImage != "" && (
                      <div className="col-12 text-center">
                        ...
                        >
                          ...
                          />
                          {/* <img src={dataImage} width="200" height="200" /> */}
                        </Badge>
                      </div>
                    )} 
                    {urlFIleView.length == 0 && (
                      <div className="col-12 text-center pd-t10">
                        <button className="btn btn-default" type="button"><label htmlFor="files">Update Photo</label></button>
                      </div>
                    )}
                    {urlFIleView.length > 0 && (
                      <div className="col-12 text-center pd-t10">
